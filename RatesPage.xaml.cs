...
public partial class RatesPage : ContentPage
{
    ...
    private static RatesPage instance;
    public static RatesPage Page
    {
        get
        {
            if (instance == null)
                instance = new RatesPage();
                return instance;
        }
    }
...
new Doviz()
{
    ...
    private class dovizListe
    {
        public static List<Doviz> ItemsSource { get; internal set; }
    }
}